function run() {
  ...
  const nameEl = reviewItem.querySelector(".review-name");
  const textEl = reviewItem.querySelector(".review-text p");
  const iconEl = reviewItem.querySelector(".icon-wrapper");

  const reviews = [
    {
      name: "Katzby",
      review:
        "This beautiful service & website is officially lynx-approved. Mrawr.",
      icon: `
            <svg class="fill-white transition-all h-[5rem] w-[5rem] md:h-[6rem] md:w-[6rem] lg:h-[8rem] lg:w-[8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    {
      name: "lilbigwhiteowl",
      review: "Video Editing | Recommended.",
      icon: `
            <svg class="fill-white transition-all h-[5rem] w-[5rem] md:h-[6rem] md:w-[6rem] lg:h-[8rem] lg:w-[8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    {
      name: "giljacek",
      review: "Video Editing | Fast and perfect execution.",
      icon: `
            <svg class="fill-white transition-all h-[5rem] w-[5rem] md:h-[6rem] md:w-[6rem] lg:h-[8rem] lg:w-[8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    {
      name: "codewizard",
      review: "Web Development | Outstanding code quality and support.",
      icon: `
            <svg class="fill-white transition-all h-[5rem] w-[5rem] md:h-[6rem] md:w-[6rem] lg:h-[8rem] lg:w-[8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    {
      name: "filmfanatic",
      review: "Video Editing | Exceptional quality and attention to detail.",
      icon: `
            <svg class="fill-white transition-all h-[5rem] w-[5rem] md:h-[6rem] md:w-[6rem] lg:h-[8rem] lg:w-[8rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
  ...
  function showNextReview() {
    ...
    typeText(nameEl, review.name, 50, () => {
      typeText(textEl, review.review, 50, () => {
        deletingTimeout = setTimeout(() => {
          deleteText(textEl, 30, () => {
            deleteText(nameEl, 30, () => {
              iconEl.classList.add("flip-out-hor-top");
              setTimeout(() => {
                showNextReview();
              }, 800);
            });
