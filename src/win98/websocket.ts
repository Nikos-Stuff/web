...
const indicator = document.getElementById("brush-indicator") as HTMLDivElement;
  ...
  ws.onmessage = (e) => {
    ...
    switch (msg.event) {
      ...
      case "user.typing":
        ...
        if (userRow) {
          userRow.cells[1].innerText = msg.data.typing ? "Typing..." : "Online";
        }
        break;
      case "error":
        log_message(
