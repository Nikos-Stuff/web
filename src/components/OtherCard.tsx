...
type Props = {
    entry: CollectionEntry<"otherprojects">; // Include team collection type
    pill?: boolean;
};
...
export default function TeamCard({ entry, pill }: Props) {
    ...
    return (
        <a href={getEntryLink()}  class="group h-[6rem] p-4 gap-3 flex items-center border rounded-lg hover:scale-105 hover:bg-black/5 hover:dark:bg-white/10 border-black/15 dark:border-white/20 transition-all duration-300 ease-in-out relative">
