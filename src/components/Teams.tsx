...
type Props = {
    tags: string[]
    data: CollectionEntry<"team">[]
}

export default function Teams({ data, tags }: Props) {
    const [filter, setFilter] = createSignal(new Set<string>())
    const [teams, setteams] = createSignal<CollectionEntry<"team">[]>([])

    createEffect(() => {
        setteams(data.filter((entry) =>
            ...
            <div class="col-span-3 sm:col-span-2">
                <div class="flex flex-col">
                    <div class="text-sm uppercase mb-2">
                        POKAZUJĘ {teams().length} Z {data.length}
                    </div>
